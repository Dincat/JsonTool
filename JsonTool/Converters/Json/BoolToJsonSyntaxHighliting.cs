...
namespace JsonTool.Converters.Json
{
    class BoolToJsonSyntaxHighliting : IValueConverter
    {
        ...
        {
            using (var stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("JsonTool.Resources.avalonEditJson.xshd"))
            {
            ...
            using (var stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("JsonTool.Resources.avalonEditJsonReadOnly.xshd"))
            {
                using (var reader = new System.Xml.XmlTextReader(stream))
                {
